...
<div class="max-w-3xl">
    <form method="POST" action="{{ route('admin.events.store') }}" enctype="multipart/form-data" class="space-y-5">
        ...
        <div class="flex items-center gap-2">
            <input type="checkbox" name="registration_open" value="1" id="reg_open" @checked(old('registration_open')) class="rounded">
        ...
        <div>
            ...
            <textarea name="description" rows="5" class="w-full rounded-lg bg-slate-900 border border-slate-700 px-4 py-2 text-sm text-slate-100 focus:border-blue-500 focus:outline-none">{{ old('description') }}</textarea>
        </div>
